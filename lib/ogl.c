...
typedef struct {
    ...
    oint16_t		 a2;
    oint16_t		 a3;
} nat_i16_i16_i16_i16_t;
typedef struct {
    ouint16_t		 a0;
    ouint16_t		 a1;
    ouint16_t		 a2;
    ouint16_t		 a3;
} nat_u16_u16_u16_u16_t;
typedef struct {
    oint32_t		 a0;
    oint32_t		 a1;
    oint32_t		 a2;
    oint32_t		 a3;
} nat_i32_i32_i32_i32_t;
typedef struct {
    oint32_t		 a0;
    oint32_t		 a1;
    ouint32_t		 a2;
    ovector_t		*a3;
} nat_i32_i32_u32_vec_t;
typedef struct {
    ouint32_t		 a0;
    ouint32_t		 a1;
    ouint32_t		 a2;
    ouint32_t		 a3;
} nat_u32_u32_u32_u32_t;
typedef struct {
    ouint32_t		 a0;
    oint32_t		 a1;
    ouint32_t		 a2;
    ovector_t		*a3;
} nat_u32_i32_u32_vec_t;
typedef struct {
    ofloat32_t		 a0;
    ofloat32_t		 a1;
    ofloat32_t		 a2;
    ofloat32_t		 a3;
} nat_f32_f32_f32_f32_t;
typedef struct {
    ofloat64_t		 a0;
    ofloat64_t		 a1;
    ofloat64_t		 a2;
...
typedef struct {
    ...
    ofloat32_t		 a5;
    ovector_t		*a6;
} nat_i32_i32_f32_f32_f32_f32_vec_t;
typedef struct {
    ouint32_t		 a0;
    oint32_t		 a1;
    oint32_t		 a2;
...
typedef struct {
    ...
    ouint32_t		 a5;
    oint32_t		 a6;
} nat_u32_i32_u32_i32_i32_i32_i32_t;
typedef struct {
    ouint32_t		 a0;
    oint32_t		 a1;
    oint32_t		 a2;
    ...
    ouint32_t		 a6;
    ovector_t		*a7;
} nat_u32_i32_i32_i32_i32_i32_u32_vec_t;
typedef struct {
    ouint32_t		 a0;
    oint32_t		 a1;
    oint32_t		 a2;
    ...
    ouint32_t		 a6;
    oint32_t		 a7;
} nat_u32_i32_i32_i32_i32_i32_i32_i32_t;
typedef struct {
    ouint32_t		 a0;
    oint32_t		 a1;
    oint32_t		 a2;
    ...
    oint32_t		 a6;
    oint32_t		 a7;
} nat_u32_i32_u32_i32_i32_i32_i32_i32_t;
typedef struct {
    ouint32_t		 a0;
    ofloat64_t		 a1;
    ofloat64_t		 a2;
    ...
    oint32_t		 a6;
    ovector_t		*a7;
} nat_u32_f64_f64_i32_f64_f64_i32_vec_t;
...
static void native_TexEnvMode(oobject_t list, oint32_t ac);
static void native_TexEnvLight(oobject_t list, oint32_t ac);
static void native_TexEnvColor(oobject_t list, oint32_t ac);
static void native_GetTexEnvMode(oobject_t list, oint32_t ac);
static void native_GetTexEnvLight(oobject_t list, oint32_t ac);
static void native_GetTexEnvColor(oobject_t list, oint32_t ac);
static void native_TexParameter(oobject_t list, oint32_t ac);
static void native_TexBorderColor(oobject_t list, oint32_t ac);
static void native_GetTexParameter(oobject_t list, oint32_t ac);
static void native_GetTexBorderColor(oobject_t list, oint32_t ac);
...
init_gl(void)
{
    ...
    define_builtin1(t_void,    Index, t_float64);
    ...
    define_builtin2(t_void,    PixelStore, t_uint32, t_float32);
    ...
    define_builtin1(t_void,    TexEnvMode, t_int32);
    define_builtin1(t_void,    TexEnvLight, t_int32);
    define_builtin1(t_void,    TexEnvColor, t_vector|t_float32);
    define_builtin0(t_int32,   GetTexEnvMode);
    define_builtin0(t_int32,   GetTexEnvLight);
    define_builtin1(t_void,    GetTexEnvColor, t_vector|t_float32);
    define_builtin3(t_void,    TexParameter, t_uint32, t_uint32, t_float32);
    define_builtin3(t_void,    TexBorderColor,
		    t_uint32, t_uint32, t_vector|t_float32);
    define_builtin2(t_float64, GetTexParameter, t_uint32, t_uint32);
    define_builtin3(t_void,    GetTexBorderColor,
		    t_uint32, t_uint32, t_vector|t_float32);
    define_builtin3(t_int32,   GetTexLevelParameter,
		    t_uint32, t_int32, t_uint32);
    define_builtin7(t_void,    TexImage1D,
		    t_uint32, t_int32, t_int32, t_int32, t_int32, t_uint32,
		    t_vector|t_float32);
    define_builtin8(t_void,    TexImage2D,
		    t_uint32, t_int32, t_int32, t_int32, t_int32, t_int32,
		    t_uint32, t_vector|t_float32);
    define_builtin4(t_void,    GetTexImage,
		    t_uint32, t_int32, t_uint32, t_vector|t_float32);
...
/* void BlendFunc(uint32_t func, float32_t ref); */
{
    GET_THREAD_SELF()
    oregister_t				*r0;
    nat_u32_u32_t			*alist;
...
/* void PolygonStipple(uint8_t mask[128]); */
{
    ...
    r0 = &thread_self->r0;
    if (alist->a0 == null || otype(alist->a0) != (t_vector|t_uint8) ||
	alist->a0->length != 128)
...
/* void ClipPlane(uint32_t plane, float64_t equation[4]) */
{
    ...
    r0 = &thread_self->r0;
    if (alist->a1 == null || otype(alist->a1) != (t_vector|t_float64) ||
	alist->a1->length != 4)
	ovm_raise(except_invalid_argument);
    r0->t = t_void;
...
/* void GetBooleanv(uint32_t pname, uint8_t params[]) */
{
    ...
    alist = (nat_u32_vec_t *)list;
    r0 = &thread_self->r0;
    if (alist->a1 == null || otype(alist->a1) != (t_vector|t_uint8))
	ovm_raise(except_invalid_argument);
    switch (alist->a0) {
	case GL_ALPHA_TEST:
	case GL_AUTO_NORMAL:
...
/* void GetFloatv(uint32_t pname, float32_t params[]) */
{
    ...
    alist = (nat_u32_vec_t *)list;
    r0 = &thread_self->r0;
    if (alist->a1 == null || otype(alist->a1) != (t_vector|t_float32))
	ovm_raise(except_invalid_argument);
    switch (alist->a0) {
	case GL_ALPHA_BIAS:
	case GL_ALPHA_SCALE:
...
/* void GetIntegerv(uint32_t pname, int32_t params[]) */
{
    ...
    alist = (nat_u32_vec_t *)list;
    r0 = &thread_self->r0;
    if (alist->a1 == null || otype(alist->a1) != (t_vector|t_int32))
	ovm_raise(except_invalid_argument);
    switch (alist->a0) {
...
/* void LoadMatrix(float64_t m[16]); */
{
    ...
    alist = (nat_vec_t *)list;
    r0 = &thread_self->r0;
    if (alist->a0 == null || otype(alist->a0) != (t_vector|t_float64) ||
	alist->a0->length != 16)
	ovm_raise(except_invalid_argument);
    r0->t = t_void;
...
/* void CallLists(uint32_t lists[]); */
{
    ...
    alist = (nat_vec_t *)list;
    r0 = &thread_self->r0;
    if (alist->a0 == null || otype(alist->a0) != (t_vector|t_uint32))
	ovm_raise(except_invalid_argument);
    r0->t = t_void;
...
/* void Color3v(float32_t v[3]); */
{
    ...
    alist = (nat_vec_t *)list;
    r0 = &thread_self->r0;
    if (alist->a0 == null || otype(alist->a0) != (t_vector|t_float32) ||
	alist->a0->length != 3)
	ovm_raise(except_invalid_argument);
    r0->t = t_void;
...
/* void Lightv(uint32_t light, uint32_t pname, float32_t params[]); */
{
    ...
    if (alist->a2 == null || otype(alist->a2) != (t_vector|t_float32) ||
	alist->a2->length != length)
	ovm_raise(except_invalid_argument);
    r0->t = t_void;
...
/* void PixelStore(uint32_t pname, float32_t param); */
{
    GET_THREAD_SELF()
    oregister_t				*r0;
    nat_u32_f32_t			*alist;
    ...
    r0 = &thread_self->r0;
    r0->t = t_void;
    glPixelStoref(alist->a0, alist->a1);
}
...
/* void PixelMapv(uint32_t map, float32_t values[]); */
{
    GET_THREAD_SELF()
    oregister_t				*r0;
    nat_u32_vec_t			*alist;
	       ...
	       uint8_t bitmap[]); */ 
{
    ...
    if (alist->a6 == null || otype(alist->a6) != (t_vector|t_uint8) ||
		   ...
		   uint32_t format, uint8_t bitmap[]); */
{
    ...
    alist = (nat_i32_i32_i32_i32_u32_vec_t *)list;
    r0 = &thread_self->r0;
    if (alist->a5 == null || otype(alist->a5) != (t_vector|t_uint8))
	ovm_raise(except_invalid_argument);
    length = (alist->a2 + 7) & ~7;
		   ...
		   uint32_t format, float32_t pixels[]); */
{
	...
	alist->a3->length < length)
	ovm_raise(except_invalid_argument);
    r0->t = t_void;
    glDrawPixels(alist->a0, alist->a1, alist->a2, GL_FLOAT, alist->a3->v.f32);
}
		   ...
		   uint32_t format, uint8_t bitmap[]); */
{
    ...
    if (alist->a3 == null || otype(alist->a3) != (t_vector|t_uint8) ||
	alist->a3->length < length)
	ovm_raise(except_invalid_argument);
    r0->t = t_void;
...
/* void TexGenv(uint32_t coord, uint32_t pname, float64_t params[]); */
{
    ...
    alist = (nat_u32_u32_vec_t *)list;
    r0 = &thread_self->r0;
    if (alist->a2 == null || otype(alist->a2) != (t_vector|t_float64) ||
	alist->a2->length != 4)
	ovm_raise(except_invalid_argument);
    r0->t = t_void;
...
static void
native_TexEnvMode(oobject_t list, oint32_t ac)
/* void TexEnvMode(int32_t param); */
{
    GET_THREAD_SELF()
    oregister_t				*r0;
    nat_u32_t				*alist;
    ...
    r0 = &thread_self->r0;
    r0->t = t_void;
    glTexEnvi(GL_TEXTURE_ENV, GL_TEXTURE_ENV_MODE, alist->a0);
}

static void
native_TexEnvLight(oobject_t list, oint32_t ac)
/* void TexEnvLight(int32_t param); */
{
    GET_THREAD_SELF()
    oregister_t				*r0;
    nat_u32_t				*alist;
    ...
    r0 = &thread_self->r0;
    r0->t = t_void;
    glTexEnvi(GL_TEXTURE_ENV, GL_TEXTURE_LIGHTING_MODE_HP, alist->a0);
}

static void
native_TexEnvColor(oobject_t list, oint32_t ac)
/* void TexEnvColor(float32_t color[]); */
{
    GET_THREAD_SELF()
    oregister_t				*r0;
    nat_vec_t				*alist;
	...
	ovm_raise(except_invalid_argument);
    r0->t = t_void;
    glTexEnvfv(GL_TEXTURE_ENV, GL_TEXTURE_ENV_COLOR, alist->a0->v.f32);
}

static void
native_GetTexEnvMode(oobject_t list, oint32_t ac)
/* int32_t GetTexEnvMode(); */
{
    GET_THREAD_SELF()
    oregister_t				*r0;
    GLint				 value[4];
...
static void
native_GetTexEnvLight(oobject_t list, oint32_t ac)
/* int32_t GetTexEnvLight(); */
{
    GET_THREAD_SELF()
    oregister_t				*r0;
    GLint				 value[4];
    ...
    r0 = &thread_self->r0;
    r0->t = t_word;
    glGetTexEnviv(GL_TEXTURE_ENV, GL_TEXTURE_LIGHTING_MODE_HP, value);
    r0->v.w = value[0];
}

static void
native_GetTexEnvColor(oobject_t list, oint32_t ac)
/* void GetTexEnvColor(float32_t color[]); */
{
    GET_THREAD_SELF()
    oregister_t				*r0;
    nat_vec_t				*alist;
...
static void
native_TexBorderColor(oobject_t list, oint32_t ac)
/* void TexBorderColor(uint32_t target, float32_t color[4]); */
{
    GET_THREAD_SELF()
    oregister_t				*r0;
    nat_u32_vec_t			*alist;
	...
	ovm_raise(except_invalid_argument);
    r0->t = t_void;
    glTexParameterfv(alist->a0, GL_TEXTURE_BORDER_COLOR, alist->a1->v.f32);
}

/* Builtins cannot return t_float32 */
static void
native_GetTexParameter(oobject_t list, oint32_t ac)
/* float64_t GetTexParameter(uint32_t target, uint32_t pname); */
{
    GET_THREAD_SELF()
    oregister_t				*r0;
    nat_u32_u32_t			*alist;
    /* Just to not need to invalid call to 4 elements */
    GLfloat				 value[4];

    alist = (nat_u32_u32_t *)list;
    r0 = &thread_self->r0;
    r0->t = t_float;
    glGetTexParameterfv(alist->a0, alist->a1, value);
    r0->v.d = value[0];
}

static void
native_GetTexBorderColor(oobject_t list, oint32_t ac)
/* void GetTexBorderColor(uint32_t target, float32_t color[4]); */
{
    GET_THREAD_SELF()
    oregister_t				*r0;
    nat_u32_vec_t			*alist;
    ...
    r0->t = t_void;
    glGetTexParameterfv(alist->a0, GL_TEXTURE_BORDER_COLOR, alist->a1->v.f32);
}
...
/* void TexImage1D(uint32_t target, int32_t level, int32_t internalformat,
		   ...
		   float32_t pixels[]); */
{
    ...
    length = alist->a3 /* width */ - (alist->a4 /* border */ << 1);
    if (length & (length - 1))
	ovm_raise(except_invalid_argument);
	...
	case GL_DEPTH_COMPONENT:
	    length = alist->a3;		/* width */
	    break;
	case GL_RGB:
	    check_mult(alist->a3, 3);
	    length = alist->a3 * 3;
	    break;
	case GL_RGBA:
	    check_mult(alist->a3, 4);
	    length = alist->a3 * 4;
	    break;
	default:
	    ovm_raise(except_invalid_argument);
	...
	ovm_raise(except_invalid_argument);
    r0->t = t_void;
    glTexImage1D(alist->a0, alist->a1, alist->a2, alist->a3, alist->a4,
		   ...
		   uint32_t format, float32_t pixels[]); */
{
    ...
    length = alist->a3 /* width */ - (alist->a5 /* border */ << 1);
    if (length & (length - 1))
	ovm_raise(except_invalid_argument);
    /* width and height must be !2^n - (border * 2)" for an integer "n" */
    length = alist->a4 /* height */ - (alist->a5 /* border */ << 1);
    if (length & (length - 1))
	ovm_raise(except_invalid_argument);
    switch (alist->a6 /* format */) {
	case GL_COLOR_INDEX:
	case GL_RED:
	case GL_GREEN:
	case GL_BLUE:
	...
	ovm_raise(except_invalid_argument);
    r0->t = t_void;
    glTexImage2D(alist->a0, alist->a1, alist->a2, alist->a3, alist->a4,
		 alist->a5, alist->a6, GL_FLOAT, alist->a7->v.f32);
}
...
/* void AreTexturesResident(uint32_t textures[], uint8_t residences[]); */
{
    ...
    r0 = &thread_self->r0;
    if (alist->a0 == null || otype(alist->a0) != (t_vector|t_uint32) ||
	alist->a1 == null || otype(alist->a1) != (t_vector|t_uint8) ||
	alist->a0->length != alist->a1->length)
	ovm_raise(except_invalid_argument);
    r0->t = t_void;
...
/* void TexSubImage1D(uint32_t target, int32_t level, int32_t xoffset,
		      int32_t width, uint32_t format, float32_t pixels[]); */
{
    GET_THREAD_SELF()
    oregister_t				*r0;
...
/* void CopyTexImage1D(uint32_t target, int32_t level, uint32_t internalformat,
...
/* void CopyTexImage2D(uint32_t target, int32_t level, uint32_t internalformat,
	     ...
	     float64_t points[]); */
{
    ...
    check_mult(length, mult);
    length *= mult;
    if (alist->a7 == null || otype(alist->a7) != (t_vector|t_float64) ||
	alist->a7->length < length)
	ovm_raise(except_invalid_argument);
    r0->t = t_void;
